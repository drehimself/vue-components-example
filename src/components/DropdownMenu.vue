<template>
  <div class="relative">
    ...
    <!-- <div class="absolute right-0 bg-gray-300 border w-64 mt-2">
      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repudiandae ut alias labore minus, corporis deserunt assumenda magnam perspiciatis, tenetur maiores laudantium nisi sequi distinctio voluptatem accusantium aliquam eius ullam! Adipisci!
    </div> -->

    <!-- <ul class="absolute normal-case font-normal right-0 bg-white shadow overflow-hidden rounded w-48 border mt-2 py-1 z-20">
      <li>
      ...
      <li>
        <a href="https://google.ca" class="flex items-center px-3 py-3 hover:bg-gray-200">
