  ...
  <div class="relative">
    ...
    <transition name="dropdown-fade">
      <ul v-on-clickaway="hideDropdown" v-if="isVisible" ref="dropdown" class="absolute normal-case font-normal right-0 bg-white shadow overflow-hidden rounded w-48 border mt-2 py-1 z-20">
        <li>
          <a @keydown.tab.exact="focusNext(false)" @keydown.up.exact.prevent="" @keydown.down.exact.prevent="focusNext(true)" ref="account" @keydown.esc.exact="hideDropdown" href="#" class="flex items-center px-3 py-3 hover:bg-gray-200">
        ...
        <li>
          <a @keydown.tab.exact="focusNext(false)" @keydown.shift.tab="focusPrevious(false)" @keydown.up.exact.prevent="focusPrevious(true)" @keydown.down.exact.prevent="focusNext(true)" @keydown.esc.exact="hideDropdown" href="#" class="flex items-center px-3 py-3 hover:bg-gray-200">
        ...
        <li>
          <a @keydown.tab.exact="focusNext(false)" @keydown.shift.tab="focusPrevious(false)" @keydown.up.exact.prevent="focusPrevious(true)" @keydown.down.exact.prevent="focusNext(true)" @keydown.esc.exact="hideDropdown" href="https://google.ca" class="flex items-center px-3 py-3 hover:bg-gray-200">
        ...
        <li>
          <a @keydown.shift.tab="focusPrevious(false)" @keydown.up.exact.prevent="focusPrevious(true)" @keydown.down.exact.prevent="" @keydown.tab.exact="hideDropdown" @keydown.esc.exact="hideDropdown" href="#" class="flex items-center px-3 py-3 hover:bg-gray-200">
